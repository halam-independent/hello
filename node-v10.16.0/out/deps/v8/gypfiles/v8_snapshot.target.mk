...
quiet_cmd__home_tests_hello_node_v10_16_0_deps_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = ACTION generating: "$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc" $@
cmd__home_tests_hello_node_v10_16_0_deps_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps/v8/gypfiles; mkdir -p $(obj).$(TOOLSET)/v8_snapshot/geni; "$(builddir)/mksnapshot" --turbo_instruction_scheduling --startup_src "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.cc"
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: $(builddir)/mksnapshot FORCE_DO_CMD
	$(call do_cmd,_home_tests_hello_node_v10_16_0_deps_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
action__home_tests_hello_node_v10_16_0_deps_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
...
$(OBJS): | $(action__home_tests_hello_node_v10_16_0_deps_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
...
$(obj).target/deps/v8/gypfiles/libv8_snapshot.a: | $(action__home_tests_hello_node_v10_16_0_deps_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__home_tests_hello_node_v10_16_0_deps_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs): | $(obj).target/deps/v8/gypfiles/libv8_base.a $(builddir)/mksnapshot $(obj).target/deps/v8/gypfiles/js2c.stamp
